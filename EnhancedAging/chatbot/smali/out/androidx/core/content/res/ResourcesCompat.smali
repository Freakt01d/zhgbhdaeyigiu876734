...
.method private static loadFont(Landroid/content/Context;Landroid/content/res/Resources;Landroid/util/TypedValue;IILandroidx/core/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;ZZ)Landroid/graphics/Typeface;
    ...
    move-result-object v0
    :try_end_3f
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_3b .. :try_end_3f} :catch_f9
    .catch Ljava/io/IOException; {:try_start_3b .. :try_end_3f} :catch_d6
    ...
    move-result-object v1
    :try_end_50
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_3f .. :try_end_50} :catch_c9
    .catch Ljava/io/IOException; {:try_start_3f .. :try_end_50} :catch_d6
    ...
    invoke-virtual {v14, v8, v15}, Landroidx/core/content/res/ResourcesCompat$FontCallback;->callbackFailAsync(ILandroid/os/Handler;)V
    :try_end_5e
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_54 .. :try_end_5e} :catch_67
    ...
    :try_end_6f
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_6d .. :try_end_6f} :catch_c9
    .catch Ljava/io/IOException; {:try_start_6d .. :try_end_6f} :catch_d6
    ...
    move-result-object v0
    :try_end_a7
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_8b .. :try_end_a7} :catch_c1
    .catch Ljava/io/IOException; {:try_start_8b .. :try_end_a7} :catch_bd
    ...
    :try_end_b3
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_ac .. :try_end_b3} :catch_b6
