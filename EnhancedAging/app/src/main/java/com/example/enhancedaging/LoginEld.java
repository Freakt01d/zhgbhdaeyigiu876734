...
public class LoginEld extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_eld);
        ...
        buttonLogin.setOnClickListener(v -> {
            ...
            if (TextUtils.isEmpty(input)) {
                Toast.makeText(LoginEld.this, "Please enter an email or phone number", Toast.LENGTH_SHORT).show();
            } else {
                processLogin(input);
            }
        });
    ...
    private void processLogin(String input) {
        if (Patterns.EMAIL_ADDRESS.matcher(input).matches()) {
            Intent intent = new Intent(LoginEld.this, EmailPass.class);
            intent.putExtra("email", input);
            startActivity(intent);
        } else if (Patterns.PHONE.matcher(input).matches()) {
            Intent intent = new Intent(LoginEld.this, PhoneAuth.class);
            intent.putExtra("phone", input);
            startActivity(intent);
        } else {
            Toast.makeText(LoginEld.this, "Please enter a valid email or phone number", Toast.LENGTH_SHORT).show();
        }
    }
        ...
        firebaseAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, task -> {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(LoginEld.this, "Authentication Failed.", Toast.LENGTH_SHORT).show();
                    }
                });
    }
        ...
        usersRef.child(user.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    Intent intent = new Intent(LoginEld.this, Dashboard.class);
                    startActivity(intent);
                    finish();
                } else {
                    Intent intent = new Intent(LoginEld.this, ElderSignupPre.class);
                    startActivity(intent);
                    finish();
                }
            }
...
// In case of an error or cancellation of the database read operation, log or handle it here.
                Toast.makeText(LoginEld.this, "Failed to check user data: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}
