...
public class Prescription extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reports_med);
        ...
        displayButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent displayIntent = new Intent(Prescription.this, DisplayPres.class);
                ...
                if (elderEmail != null && !elderEmail.isEmpty()) {
                    ...
                    Toast.makeText(Prescription.this, "Elder's email is not available.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void uploadImageAndSaveReport(String hospitalName, String description) {
        ...
        uploadTask.continueWithTask(task -> {
            ...
            if (task.isSuccessful()) {
                ...
                Toast.makeText(Prescription.this, "Failed to upload image", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void saveReportToFirestore(String hospitalName, String description, String imageUrl) {
        ...
        db.collection("elders")
                ...
                .add(reportMap)
                .addOnSuccessListener(documentReference -> Toast.makeText(Prescription.this, "Report saved successfully", Toast.LENGTH_SHORT).show())
                .addOnFailureListener(e -> Toast.makeText(Prescription.this, "Error saving report", Toast.LENGTH_SHORT).show());
    }
