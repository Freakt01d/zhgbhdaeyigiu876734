...
public class ProfileViewFam extends AppCompatActivity {

    private TextView usernameTextView, emailTextView, nameTextView, ageTextView, phoneTextView, aadhaarTextView;

    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_profile_view_fam);
    ...
    private void fetchUserProfile(String userEmail) {
        ...
        DatabaseReference databaseReference = database.getReference().child("families");
