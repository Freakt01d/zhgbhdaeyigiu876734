...
.method static tryRequestLocationUpdates(Landroid/location/LocationManager;Ljava/lang/String;Landroidx/core/location/LocationRequestCompat;Landroidx/core/location/LocationListenerCompat;Landroid/os/Looper;)Z
    ...
    :try_end_4b
    .catch Ljava/lang/NoSuchMethodException; {:try_start_7 .. :try_end_4b} :catch_55
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_7 .. :try_end_4b} :catch_53
    .catch Ljava/lang/IllegalAccessException; {:try_start_7 .. :try_end_4b} :catch_51
    .catch Ljava/lang/ClassNotFoundException; {:try_start_7 .. :try_end_4b} :catch_4f
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_7 .. :try_end_4b} :catch_4d
...
.method static tryRequestLocationUpdates(Landroid/location/LocationManager;Ljava/lang/String;Landroidx/core/location/LocationRequestCompat;Landroidx/core/location/LocationManagerCompat$LocationListenerTransport;)Z
    ...
    monitor-enter v5
    :try_end_41
    .catch Ljava/lang/NoSuchMethodException; {:try_start_7 .. :try_end_41} :catch_63
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_7 .. :try_end_41} :catch_61
    .catch Ljava/lang/IllegalAccessException; {:try_start_7 .. :try_end_41} :catch_5f
    .catch Ljava/lang/ClassNotFoundException; {:try_start_7 .. :try_end_41} :catch_5d
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_7 .. :try_end_41} :catch_5b
    ...
    throw v1
    :try_end_5a
    .catch Ljava/lang/NoSuchMethodException; {:try_start_59 .. :try_end_5a} :catch_63
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_59 .. :try_end_5a} :catch_61
    .catch Ljava/lang/IllegalAccessException; {:try_start_59 .. :try_end_5a} :catch_5f
    .catch Ljava/lang/ClassNotFoundException; {:try_start_59 .. :try_end_5a} :catch_5d
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_59 .. :try_end_5a} :catch_5b
